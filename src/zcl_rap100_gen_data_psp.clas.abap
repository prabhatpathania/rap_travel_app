CLASS zcl_rap100_gen_data_psp DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_psp IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'PSP',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atravpsp.
*    DELETE FROM zrap100_dtravpsp.

    "insert travel demo data
    INSERT zrap100_atravpsp  FROM (
        SELECT
